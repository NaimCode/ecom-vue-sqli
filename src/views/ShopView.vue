...
<template>
  ...
  <div class="section grid md:grid-cols-[300px_auto] gap-10">
    <div class="space-y-3 md:space-y-10">
      <burron
        @click="collapse = !collapse"
        class="flex flex-row justify-between items-center cursor-pointer bg-[#3C3C3C] text-white p-2 rounded-md text-xs"
      >
        <span>Collapse</span>
        <span>
          {{ collapse ? "-" : "+" }}
      ...
      <div v-show="collapse" class="space-y-3 md:space-y-10">
        <div class="">
